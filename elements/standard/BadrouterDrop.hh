#ifndef CLICK_BADROUTERDROP_HH
#define CLICK_BADROUTERDROP_HH
...
BadrouterDrop listens for upstream notification, such as that available from
Queue.
...
class BadrouterDrop : public Element { public:

    BadrouterDrop() CLICK_COLD;

    const char *class_name() const	{ return "BadrouterDrop"; }
